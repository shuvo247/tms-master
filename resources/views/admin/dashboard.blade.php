            ...
            <div class="card card-hover p-t-10">
                <div class="card-body">
                    <div class="p-t-20 text-center">
                        ...
                        <a href="javascript:void(0)" class="waves-effect waves-light m-t-20 btn btn-lg btn-info accent-4 m-b-20">View
                            More Details</a>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table no-wrap v-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex no-block align-items-center">
                                            <div class="m-r-10"><img src="../assets/images/users/10.jpg" alt="user" class="rounded-circle" width="45" /></div>
                                            <div class="">
                                                <h5 class="m-b-0 font-16 font-medium">Sasa Mohamed</h5>
                                                <span>Sasa@email.com</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Lorem ipsum nisi quis ex in cupidatat.</td>
                                    <td>
                                    ...
                                    <td><i class="fa fa-circle text-pink" data-toggle="tooltip" data-placement="top" title="In Progress"></i></td>
                                    <td>35</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex no-block align-items-center">
                                            ...
                                            <div class="">
                                                <h5 class="m-b-0 font-16 font-medium">Joe Done</h5>
                                                belostemas@gmail.com</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Lorem ipsum nisi quis ex in cupidatat.</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex no-block align-items-center">
                                            <div class="m-r-10"><img src="../assets/images/users/6.jpg" alt="user" class="rounded-circle" width="45" /></div>
                                            <div class="">
                                    ...
                                    <td>
                                        <div class="popover-icon">
                                            <a class="btn-circle btn btn-info" href="javascript:void(0)">SS</a>
                                            <a class="btn-circle btn btn-cyan text-white popover-item" href="javascript:void(0)">DS</a>
                                            <a class="btn-circle btn btn-pink text-white popover-item" href="javascript:void(0)">RP</a>
                                            <a class="btn-circle btn btn-outline-secondary" href="javascript:void(0)">+</a>
                                        </div>
                                    </td>
                                    <td><i class="fa fa-circle text-success" data-toggle="tooltip" data-placement="top" title="Active"></i></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="popover-icon">
                                            <a class="btn-circle btn btn-pink text-white" href="javascript:void(0)">RP</a>
                                            <a class="btn-circle btn btn-outline-secondary" href="javascript:void(0)">+</a>
                                        </div>
                                    </td>
                                    <td><i class="fa fa-circle text-pink" data-toggle="tooltip" data-placement="top" title="In Progress"></i></td>
                ...
                <div class="comment-widgets scrollable" style="height:560px;">
                    ...
                    <div class="d-flex flex-row comment-row m-t-0">
                        ...
                        <div class="comment-text w-100">
                            <h6 class="font-medium">Belostemas</h6>
