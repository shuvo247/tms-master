            ...
            <div class="card">
                <div class="card-body">
                    <div style=";padding-top: 10px" class="row">
                                ...
                                <div class="col-md-8">
                                    <select class="select-2" name="supplier_id">
                                        @foreach(App\Models\Supplier::all() as $supplier)
                                            <option value="{{ $supplier->id }}" @if($purchase_invoice->supplier_id == $supplier->id)selected @endif>{{ $supplier->organization->organization_name}} | {{$supplier->supplier_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div style="margin-bottom: 5px" class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="purchase_note" name="purchase_note" value="{{ $purchase_invoice->note ?? '' }}" type="text" placeholder="Purchase note" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div style="margin-bottom: 5px" class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="purchase_date" value="{{ $purchase_invoice->purchase_date ?? '' }}" name="purchase_date" type="text" class="form-control" data-date-autoclose="true" >
                                </div>
                            </div>
                        </div>
                    </div>
                    <div style="margin-top: 5px" class="row" id="purchaseProduct">
                        ...
                        <div class="row">
                            <div class="col-12">
                                @foreach($purchase_invoice->purchaseFirst as $purchase)
                                    <div class="row">
                                                ...
                                                <select class="form-control select-2"  name="product_id[]" id="selectedProduct">
                                                    ...
                                                    @foreach ($products as $product)
                                                        @foreach($product->variable_product_stock as $stock)
                                                            <option value="variable_{{$stock->id}}" @if($purchase->product_type == 1 && $purchase->product_id == $stock->id)selected @endif>{{$product->product_name}} | {{$stock->size_attribute->attribute_value}} | {{$stock->grade_attribute->attribute_value}} | {{$product->category->category_name}} | {{$product->brand->brand_name}} </option>
                                                        @endforeach
                                                    @endforeach
                                ...
                                @endforeach
                                @foreach($purchase_invoice->purchase as $purchase)
                                    <div class="recentRow row">
                                        <div class="mb-2 col-md-3 text-dark">
                                            <div id="inputFormRow">
                                                <select class="form-control select-2"  name="product_id[]" id="selectNewRowProduct{{$loop->index+1}}">
                                                    <option> -- Select Product -- </option>
                                                    @foreach ($products as $product)
                                                        @foreach($product->variable_product_stock as $stock)
                                                            <option value="variable_{{$stock->id}}" @if($purchase->product_type == 1 && $purchase->product_id == $stock->id)selected @endif>{{$product->product_name}} | {{$stock->size_attribute->attribute_value}} | {{$stock->grade_attribute->attribute_value}} | {{$product->category->category_name}} | {{$product->brand->brand_name}} </option>
                                        ...
                                        <div class="col-md-1">
                                            <div id="inputFormRow">
                                                <div class="input-group mb-3">
                                                    <select name="" id="discountType{{$loop->index+1}}" class="form-control">
                                                        <option value="parcent">%</option>
                                                        <option value="bdt">BDT</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-md-1">
                                            <div id="inputFormRow">
                                                <div class="input-group mb-3">
                                                    <input type="text" id="purchaseDiscountValue{{$loop->index+1}}" name="discount[]" class="form-control m-input" placeholder="Discount" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <div style="margin-bottom: 5px" class="form-group row" >
                            ...
                            <div style="margin-bottom: 5px" class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="purchase_vat_amount" type="text" class="form-control width-xs" name="purchase_vat_amount" value="">
                                </div>
...
$('#purchasePcsValue'+j).keyup(function(){
   ...
   // End Create Purchase
        $('.select-2').select2();
    // Date Picker
    jQuery('.mydatepicker, #purchase_date, .input-group.date').datepicker();
